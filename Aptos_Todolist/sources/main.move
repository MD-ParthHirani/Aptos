...
//  #[view]
//     public fun get_list(account: address) acquires TodoList {
//         assert!(exists<TodoList>(account), error::not_found(ENO_MESSAGE));
//         *&borrow_global<TodoList>(account).task_counter
//     }
...
#[test(admin = @0x123)]
  ...
  #[test(admin = @0x123)]
   #[expected_failure(abort_code = E_NOT_INITIALIZED)]
  public entry fun account_can_deleted_task(admin: signer) acquires TodoList {
